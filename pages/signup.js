...
function signin() {
    ...
    return (
        <div class="flex items-center flex-col justify-center w-full p-5 bg-white h-max">
            ...
            <form method="post"  action="/api/register" class="bg-custom-blue/50 border-gray-200 rounded-3xl border-solid border-0 box-border justify-center relative w-3/5 h-5/6 shadow-xl">

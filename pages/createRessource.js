  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.cardcontent}>
        ...
        <form id="formCreate" className={styles.formu} method="post" action="/searchRessource">
          <div>
        ...
        <div className={styles.cardSchema}>
          <div className={styles.entete}>
            <div className={styles.entetename}>
              <h2 /* ref={nameres} */ id='nameresOutput'></h2>
              <p>crée par <span id="username" />le <span id="date" /></p>
              <p>prévu à <span /* ref={ville} */ id="villeOutput" /></p>
            </div>

            <div className={styles.entetename}>
              <p className={styles.category} /* ref={category} */id="categoryOutput">Categorie</p>
              <p className={styles.typesRessources} /* ref={typesRessources}*/ id="typesRessourcesOutput">Ressources</p>
              <p className={styles.typesRelations} /* ref={typesRelations} */id="typesRelationsOutput">Relations</p>
            </div>
          ...
          <div className={styles.contenuextend}>
            <div>
              ...
              <a href="fichier.pdf" /* ref={file} */id="fileOutput" download />
            </div>
            <div>

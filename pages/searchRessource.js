...
function searchRessource(props) {
  ...
  const header = <svg style={{marginLeft: "85%" }} className="inline-block cursor-pointer hover:fill-blue-500 pt-3" xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 640 512">
  ...
  const listRessources = search(ressources).map((item) => (<Card className='border-black' title={item.titreRessource} header={header}
    subTitle={(categorie[item.idCategorie - 1]).libelleCategorie}>

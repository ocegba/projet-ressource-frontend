...
const Intro = () => {
  return (
    <div classNameName={styles.IntroContainer}>
      <div classNameName={styles.IntroPres}>
        <div classNameName={styles.IntroImage}>
          <div classNameName={styles.IntroContent}>
            <div classNameName={styles.IntroItems}>
      ...
      <div classNameName={styles.searchHomeRes}>
        <div classNameName={styles.card}>
          <Image classNameName={styles.logo} src={logo} alt="loading..." width={230} height={230} />
          <h2 classNameName={styles.subTitle}>Chercher une ressource</h2>
        ...
        <div classNameName={styles.card}>
          <h2 classNameName={styles.subTitle}>Consulter les ressources de la communauté</h2>
          <Formulaire />
        </div>
      </div>
    </div>

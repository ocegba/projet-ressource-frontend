    ...
    <footer className="text-center lg:text-left bg-black text-white">
      <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
        <div className="mr-12 hidden lg:block">
          <span>Connectez-vous à nos différents réseaux sociaux :</span>
        </div>
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          ">
            ...
            <p>
              Accédez et partagez les ressources de notre communauté.
            </p>
          </div>
          ...
          <div className="">
            ...
            <p className="mb-4">
              <a href="mentionslegales.pdf" download="mentionslegales.PDF" className="text-white">Mentions légales</a>
            </p>
            <p className="mb-4">
              <a href="PolitiqueDeFonctionnalité.pdf" download="PolitiqueDeFonctionnalité.PDF" className="text-white">Politique de confidentialité</a>
            </p>
            <p className="mb-4">
              <a href="Conditions.pdf" download="Conditions.PDF" className="text-white">Conditions générales d'utilisation (Re)Sources Relationnelles</a>
            </p>
          </div>
          <div className="">
            <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
            ...
            <p className="flex items-center justify-center md:justify-start mb-4">
              ...
              Immeuble Le Quatrième <br />Zone Aéroportuaire de Montpellier Méditerranée <br />34130 Mauguio
            </p>
            <p className="flex items-center justify-center md:justify-start mb-4">
              ...
              </svg> <a href="mailto:contact@resourcesrelationnelles.fr" />
              contact@resourcesrelationnelles.fr
            </p>
          </div>
        </div>
      </div>
      <div className="text-center p-6 bg-black">
        ...
        <a className="text-white font-semibold">(RE)SOURCES RELATIONNELLES</a>
      </div>
    </footer>
  )
}

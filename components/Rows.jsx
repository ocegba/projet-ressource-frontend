...
export const RowsCompteAdmin = ({ compte }) => {
    ...
    return (
        <div class="grid grid-cols-8 gap-4 px-4 py-5 relative flex flex-col min-w-0 break-words bg-white w-full mb-3 shadow-lg rounded-lg cursor-pointer shadow-lg shadow">
            ...
            <div class="flex items-center justify-center">
                {actif(compte.isActive) === "COMPTE NON ACTIF" && <svg onClick={() => statusCompte(compte)} class="cursor-pointer" xmlns="http://www.w3.org/2000/svg" fill="red" width="60" viewBox="0 0 600 550">
                ...
                {actif(compte.isActive) === "COMPTE ACTIF" && <svg onClick={() => statusCompte(compte)} class="cursor-pointer" xmlns="http://www.w3.org/2000/svg" fill="green" width="60" viewBox="0 0 600 550">

...
/*     async function editRessource() {
        ...
        const validerRessource = "";
        await axios.put("../api/ressource/editRessource", {
            id: parseInt(ressource?.id),
            titreRessource,
            categorieRessource,
            typeRessource,
            ...
            <>
                ...
                <Modal toggle={() => setModalOpen(!modalOpen)} isOpen={modalOpen}>
                    ...
                    <ModalFooter>
                        ...
                        <Button color="primary" type="button" onClick={() => editRessource()}>
                            Modifier votre ressource
                        </Button>
                    </ModalFooter>
                </Modal>
            </>
    ...
    return (
        <div class="grid grid-cols-8 gap-4 px-4 py-5 relative flex flex-col min-w-0 break-words bg-white w-full mb-3 shadow-lg rounded-lg shadow-lg shadow">
            ...
            <div class="flex items-center justify-center">
                <svg /* onClick={() => Example()} */ class="bg-blue-400 hover:bg-blue-500 p-3 rounded-lg cursor-pointer shadow-lg shadow-blue-300" xmlns="http://www.w3.org/2000/svg" width="50" viewBox="0 0 450 535">

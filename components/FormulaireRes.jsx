  ...
  return (
    <form className={styles.formu} method="post" action="/search-a-ressource">
      ...
      <div>
        ...
        <select required name="typesRessources" id="typesRessources">
          <option value="">Sélectionnez un type de ressources</option>
      ...
      <div>
        ...
        <select required name="typesRelations" id="typesRelations">
          <option value="">Sélectionnez une ou plusieurs relations</option>
      ...
      <div>
        ...
        <select required name="ville" id="ville">

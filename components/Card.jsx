    ...
    <div class="flex-1 justify-center	items-center p-14">
      <div class="static w-600 h-550 bg-white rounded-lg drop-shadow-xl">
        ...
        <div class="h-96 bg-green-200">
          <p class="pl-2 text-justify">{ressource.contenuCommentairesource}</p>
        </div>

        <div class="grid grid-cols-3 justify-between p-2.5">
        ...
        <div class="flex justify-between p-2.5 bottom-0">
          <svg onClick={() => addParticiper()} class="inline-block cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 640 512"><path d="M224 256c70.7 0 128-57.31 128-128S294.7 0 224 0C153.3 0 96 57.31 96 128S153.3 256 224 256zM274.7 304H173.3C77.61 304 0 381.6 0 477.3C0 496.5 15.52 512 34.66 512h378.7C432.5 512 448 496.5 448 477.3C448 381.6 370.4 304 274.7 304zM616 200h-48v-48C568 138.8 557.3 128 544 128s-24 10.75-24 24v48h-48C458.8 200 448 210.8 448 224s10.75 24 24 24h48v48C520 309.3 530.8 320 544 320s24-10.75 24-24v-48h48C629.3 248 640 237.3 640 224S629.3 200 616 200z" /></svg>

          <svg onClick={() => setOpen(!open)} class="inline-block cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 512 512"><path d="M256 32C114.6 32 .0272 125.1 .0272 240c0 49.63 21.35 94.98 56.97 130.7c-12.5 50.37-54.27 95.27-54.77 95.77c-2.25 2.25-2.875 5.734-1.5 8.734C1.979 478.2 4.75 480 8 480c66.25 0 115.1-31.76 140.6-51.39C181.2 440.9 217.6 448 256 448c141.4 0 255.1-93.13 255.1-208S397.4 32 256 32z" /></svg>
      ...
      <div>
        {open ? (
          <div id="popup1" class="overlay mt-2" >
            <div class="p-3 static w-600 max_h_fit bg-white rounded-lg drop-shadow-xl">
              <a class="absolute text-3xl font-bold right-7 mt-0 hover:text-blue-600 cursor-pointer" onClick={() => setOpen(!open)}>&times;</a>
              <h2 class=" text-xl">Commentaires</h2>
              <form ref={Comment}>
                <textarea class="border-0 rounded-2xl resize-y	font-medium shadow-xl"
                  id="contenuCommentaire" maxlength="70" type="text" cols="30"
                  name="addCommentaire"
                />
                <button class="mt-2 mb-2 bg-custom-blue text-white font-bold text-xl w-fit pr-1 pl-1 rounded-xl block m-auto cursor-pointer rounded-lg transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300" type="submit" onClick={() => addNewComment()}>Commenter</button>
              </form>
            </div>
            <ul>
